# from https://github.com/BretFisher/nodejs-rocks-in-docker/blob/main/dockerfiles/distroless.Dockerfile
# but i think https://github.com/BretFisher/node-docker-good-defaults/blob/main/Dockerfile will work better.
